...
public class ProBaseValueTest {
  ...
  /** Iwo Jima (prod=1, no base) → base contribution = 0. */
  @Test
  ...
  /**
   * Gate boundary (inclusive): prod=1 is within the threshold ({@code > 1} means exclusive), so the
   * bonus formula runs. With current constants both bonuses are 0.0.
   */
  @Test
