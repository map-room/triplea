 ...
 *
 * <p>Returns the safe default (no subs submerge — press the attack) until ProAI integration
 * is wired.
 * TODO: invoke the relevant ProAI battle-step submerge logic once identified.
 */
