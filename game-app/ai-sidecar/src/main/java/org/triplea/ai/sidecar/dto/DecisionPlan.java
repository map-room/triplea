...
public sealed interface DecisionPlan
    permits SelectCasualtiesPlan, RetreatPlan, ScramblePlan,
        KamikazePlan, IgnoreSubsPlan, EngageStayHiddenPlan, InterceptPlan, SubmergePlan,
        PurchasePlan, PoliticsPlan, CombatMovePlan, NoncombatMovePlan, PlacePlan {}
